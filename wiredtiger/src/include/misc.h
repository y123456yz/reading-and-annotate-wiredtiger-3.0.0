...
#define	WT_KILOBYTE	(1024)  //1K
#define	WT_MEGABYTE	(1048576)  //1M
#define	WT_GIGABYTE	(1073741824) //1G
#define	WT_TERABYTE	((uint64_t)1099511627776) //1T
#define	WT_PETABYTE	((uint64_t)1125899906842624) //1P
...
/*判断一个item的data是否是在他的memory chunk上分配的, 判断是否已经有数据存入到mem空间 */
