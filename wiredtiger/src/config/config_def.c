...
//这些都是config_entries的成员

//这里是对WT_CONNECTION.async_new_op进行配置检查，其他类似
...
//和宏定义WT_CONFIG_ENTRY_WT_CONNECTION_add_collator等对应
...
//根据config_entries分配空间epp，然后把config_entries内推赋值给epp
int
