...
#define	WIREDTIGER_VERSION_STRING	"WiredTiger 11.1.0: (November  2, 2022)"
...
#else
#define	WT_ATTRIBUTE_LIBRARY_VISIBLE	;//__attribute__((visibility("default")))   yang add change xxxxxxxxxx
#endif
 ...
 *******************************************/
 ////__wt_named_collator.collator为该类型
...
//__wt_file_handle_inmem.iface类型，__im_file_open中赋值初始化
//__wt_file_handle_posix.iface为该类型,__posix_open_file中初始化
struct __wt_file_handle;    typedef struct __wt_file_handle WT_FILE_HANDLE;
////__wt_connection_impl.file_system为该类型为该类型，__wt_os_posix中分片空间
...
struct __wt_cursor {
	 ...
	 * arrays.
	 */
	//http://source.wiredtiger.com/11.1.0/schema.html 参考这里，也就是key类型
 ...
 * @snippet ex_file_system.c WT_FILE_SYSTEM register
 */ 
//__wt_connection_impl.file_system为该类型， __wt_os_posix中初始化
 ...
 * entries
 */
#define	WT_STAT_CONN_CURSOR_NEXT_SKIP_LT_100		1253
/*!
 * cursor: cursor next calls that skip greater than or equal to 100
 * entries
 */
#define	WT_STAT_CONN_CURSOR_NEXT_SKIP_GE_100		1254
...
#define	WT_STAT_CONN_TXN_READ_OVERFLOW_REMOVE		1487
/*! transaction: prepared transactions */
#define	WT_STAT_CONN_TXN_PREPARE			1488
/*! transaction: prepared transactions committed */
#define	WT_STAT_CONN_TXN_PREPARE_COMMIT			1489
/*! transaction: prepared transactions currently active */
#define	WT_STAT_CONN_TXN_PREPARE_ACTIVE			1490
/*! transaction: prepared transactions rolled back */
#define	WT_STAT_CONN_TXN_PREPARE_ROLLBACK		1491
/*! transaction: query timestamp calls */
#define	WT_STAT_CONN_TXN_QUERY_TS			1492
/*! transaction: race to read prepared update retry */
#define	WT_STAT_CONN_TXN_READ_RACE_PREPARE_UPDATE	1493
/*! transaction: rollback to stable calls */
#define	WT_STAT_CONN_TXN_RTS				1494
/*!
 * transaction: rollback to stable history store records with stop
 * timestamps older than newer records
 */
#define	WT_STAT_CONN_TXN_RTS_HS_STOP_OLDER_THAN_NEWER_START	1495
/*! transaction: rollback to stable inconsistent checkpoint */
#define	WT_STAT_CONN_TXN_RTS_INCONSISTENT_CKPT		1496
/*! transaction: rollback to stable keys removed */
#define	WT_STAT_CONN_TXN_RTS_KEYS_REMOVED		1497
/*! transaction: rollback to stable keys restored */
#define	WT_STAT_CONN_TXN_RTS_KEYS_RESTORED		1498
/*! transaction: rollback to stable pages visited */
#define	WT_STAT_CONN_TXN_RTS_PAGES_VISITED		1499
/*! transaction: rollback to stable restored tombstones from history store */
#define	WT_STAT_CONN_TXN_RTS_HS_RESTORE_TOMBSTONES	1500
/*! transaction: rollback to stable restored updates from history store */
#define	WT_STAT_CONN_TXN_RTS_HS_RESTORE_UPDATES		1501
/*! transaction: rollback to stable skipping delete rle */
#define	WT_STAT_CONN_TXN_RTS_DELETE_RLE_SKIPPED		1502
/*! transaction: rollback to stable skipping stable rle */
#define	WT_STAT_CONN_TXN_RTS_STABLE_RLE_SKIPPED		1503
/*! transaction: rollback to stable sweeping history store keys */
#define	WT_STAT_CONN_TXN_RTS_SWEEP_HS_KEYS		1504
/*! transaction: rollback to stable tree walk skipping pages */
#define	WT_STAT_CONN_TXN_RTS_TREE_WALK_SKIP_PAGES	1505
/*! transaction: rollback to stable updates aborted */
#define	WT_STAT_CONN_TXN_RTS_UPD_ABORTED		1506
/*! transaction: rollback to stable updates removed from history store */
#define	WT_STAT_CONN_TXN_RTS_HS_REMOVED			1507
/*! transaction: sessions scanned in each walk of concurrent sessions */
#define	WT_STAT_CONN_TXN_SESSIONS_WALKED		1508
/*! transaction: set timestamp calls */
#define	WT_STAT_CONN_TXN_SET_TS				1509
/*! transaction: set timestamp durable calls */
#define	WT_STAT_CONN_TXN_SET_TS_DURABLE			1510
/*! transaction: set timestamp durable updates */
#define	WT_STAT_CONN_TXN_SET_TS_DURABLE_UPD		1511
/*! transaction: set timestamp oldest calls */
#define	WT_STAT_CONN_TXN_SET_TS_OLDEST			1512
/*! transaction: set timestamp oldest updates */
#define	WT_STAT_CONN_TXN_SET_TS_OLDEST_UPD		1513
/*! transaction: set timestamp stable calls */
#define	WT_STAT_CONN_TXN_SET_TS_STABLE			1514
/*! transaction: set timestamp stable updates */
#define	WT_STAT_CONN_TXN_SET_TS_STABLE_UPD		1515
/*! transaction: transaction begins */
#define	WT_STAT_CONN_TXN_BEGIN				1516
/*! transaction: transaction checkpoint currently running */
#define	WT_STAT_CONN_TXN_CHECKPOINT_RUNNING		1517
/*!
 * transaction: transaction checkpoint currently running for history
 * store file
 */
#define	WT_STAT_CONN_TXN_CHECKPOINT_RUNNING_HS		1518
/*! transaction: transaction checkpoint generation */
#define	WT_STAT_CONN_TXN_CHECKPOINT_GENERATION		1519
/*!
 * transaction: transaction checkpoint history store file duration
 * (usecs)
 */
#define	WT_STAT_CONN_TXN_HS_CKPT_DURATION		1520
/*! transaction: transaction checkpoint max time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_TIME_MAX		1521
/*! transaction: transaction checkpoint min time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_TIME_MIN		1522
/*!
 * transaction: transaction checkpoint most recent duration for gathering
 * all handles (usecs)
 */
#define	WT_STAT_CONN_TXN_CHECKPOINT_HANDLE_DURATION	1523
/*!
 * transaction: transaction checkpoint most recent duration for gathering
 * applied handles (usecs)
 */
#define	WT_STAT_CONN_TXN_CHECKPOINT_HANDLE_DURATION_APPLY	1524
/*!
 * transaction: transaction checkpoint most recent duration for gathering
 * skipped handles (usecs)
 */
#define	WT_STAT_CONN_TXN_CHECKPOINT_HANDLE_DURATION_SKIP	1525
/*! transaction: transaction checkpoint most recent handles applied */
#define	WT_STAT_CONN_TXN_CHECKPOINT_HANDLE_APPLIED	1526
/*! transaction: transaction checkpoint most recent handles skipped */
#define	WT_STAT_CONN_TXN_CHECKPOINT_HANDLE_SKIPPED	1527
/*! transaction: transaction checkpoint most recent handles walked */
#define	WT_STAT_CONN_TXN_CHECKPOINT_HANDLE_WALKED	1528
/*! transaction: transaction checkpoint most recent time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_TIME_RECENT		1529
/*! transaction: transaction checkpoint prepare currently running */
#define	WT_STAT_CONN_TXN_CHECKPOINT_PREP_RUNNING	1530
/*! transaction: transaction checkpoint prepare max time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_PREP_MAX		1531
/*! transaction: transaction checkpoint prepare min time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_PREP_MIN		1532
/*! transaction: transaction checkpoint prepare most recent time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_PREP_RECENT		1533
/*! transaction: transaction checkpoint prepare total time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_PREP_TOTAL		1534
/*! transaction: transaction checkpoint scrub dirty target */
#define	WT_STAT_CONN_TXN_CHECKPOINT_SCRUB_TARGET	1535
/*! transaction: transaction checkpoint scrub time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_SCRUB_TIME		1536
/*! transaction: transaction checkpoint stop timing stress active */
#define	WT_STAT_CONN_TXN_CHECKPOINT_STOP_STRESS_ACTIVE	1537
/*! transaction: transaction checkpoint total time (msecs) */
#define	WT_STAT_CONN_TXN_CHECKPOINT_TIME_TOTAL		1538
/*! transaction: transaction checkpoints */
#define	WT_STAT_CONN_TXN_CHECKPOINT			1539
/*! transaction: transaction checkpoints due to obsolete pages */
#define	WT_STAT_CONN_TXN_CHECKPOINT_OBSOLETE_APPLIED	1540
/*!
 * transaction: transaction checkpoints skipped because database was
 * clean
 */
#define	WT_STAT_CONN_TXN_CHECKPOINT_SKIPPED		1541
/*! transaction: transaction failures due to history store */
#define	WT_STAT_CONN_TXN_FAIL_CACHE			1542
/*!
 * transaction: transaction fsync calls for checkpoint after allocating
 * the transaction ID
 */
#define	WT_STAT_CONN_TXN_CHECKPOINT_FSYNC_POST		1543
/*!
 * transaction: transaction fsync duration for checkpoint after
 * allocating the transaction ID (usecs)
 */
#define	WT_STAT_CONN_TXN_CHECKPOINT_FSYNC_POST_DURATION	1544
/*! transaction: transaction range of IDs currently pinned */
#define	WT_STAT_CONN_TXN_PINNED_RANGE			1545
/*! transaction: transaction range of IDs currently pinned by a checkpoint */
#define	WT_STAT_CONN_TXN_PINNED_CHECKPOINT_RANGE	1546
/*! transaction: transaction range of timestamps currently pinned */
#define	WT_STAT_CONN_TXN_PINNED_TIMESTAMP		1547
/*! transaction: transaction range of timestamps pinned by a checkpoint */
#define	WT_STAT_CONN_TXN_PINNED_TIMESTAMP_CHECKPOINT	1548
/*!
 * transaction: transaction range of timestamps pinned by the oldest
 * active read timestamp
 */
#define	WT_STAT_CONN_TXN_PINNED_TIMESTAMP_READER	1549
/*!
 * transaction: transaction range of timestamps pinned by the oldest
 * timestamp
 */
#define	WT_STAT_CONN_TXN_PINNED_TIMESTAMP_OLDEST	1550
/*! transaction: transaction read timestamp of the oldest active reader */
#define	WT_STAT_CONN_TXN_TIMESTAMP_OLDEST_ACTIVE_READ	1551
/*! transaction: transaction rollback to stable currently running */
#define	WT_STAT_CONN_TXN_ROLLBACK_TO_STABLE_RUNNING	1552
/*! transaction: transaction walk of concurrent sessions */
#define	WT_STAT_CONN_TXN_WALK_SESSIONS			1553
/*! transaction: transactions committed */
#define	WT_STAT_CONN_TXN_COMMIT				1554
/*! transaction: transactions rolled back */
#define	WT_STAT_CONN_TXN_ROLLBACK			1555
/*! transaction: update conflicts */
#define	WT_STAT_CONN_TXN_UPDATE_CONFLICT		1556
 ...
 * entries
 */
#define	WT_STAT_DSRC_CURSOR_NEXT_SKIP_LT_100		2178
/*!
 * cursor: cursor next calls that skip greater than or equal to 100
 * entries
 */
#define	WT_STAT_DSRC_CURSOR_NEXT_SKIP_GE_100		2179
/*! cursor: cursor next random calls that return an error */
...
/*! transaction: number of times overflow removed value is read */
#define	WT_STAT_DSRC_TXN_READ_OVERFLOW_REMOVE		2251
/*! transaction: race to read prepared update retry */
#define	WT_STAT_DSRC_TXN_READ_RACE_PREPARE_UPDATE	2252
/*!
 * transaction: rollback to stable history store records with stop
 * timestamps older than newer records
 */
#define	WT_STAT_DSRC_TXN_RTS_HS_STOP_OLDER_THAN_NEWER_START	2253
/*! transaction: rollback to stable inconsistent checkpoint */
#define	WT_STAT_DSRC_TXN_RTS_INCONSISTENT_CKPT		2254
/*! transaction: rollback to stable keys removed */
#define	WT_STAT_DSRC_TXN_RTS_KEYS_REMOVED		2255
/*! transaction: rollback to stable keys restored */
#define	WT_STAT_DSRC_TXN_RTS_KEYS_RESTORED		2256
/*! transaction: rollback to stable restored tombstones from history store */
#define	WT_STAT_DSRC_TXN_RTS_HS_RESTORE_TOMBSTONES	2257
/*! transaction: rollback to stable restored updates from history store */
#define	WT_STAT_DSRC_TXN_RTS_HS_RESTORE_UPDATES		2258
/*! transaction: rollback to stable skipping delete rle */
#define	WT_STAT_DSRC_TXN_RTS_DELETE_RLE_SKIPPED		2259
/*! transaction: rollback to stable skipping stable rle */
#define	WT_STAT_DSRC_TXN_RTS_STABLE_RLE_SKIPPED		2260
/*! transaction: rollback to stable sweeping history store keys */
#define	WT_STAT_DSRC_TXN_RTS_SWEEP_HS_KEYS		2261
/*! transaction: rollback to stable updates removed from history store */
#define	WT_STAT_DSRC_TXN_RTS_HS_REMOVED			2262
/*! transaction: transaction checkpoints due to obsolete pages */
#define	WT_STAT_DSRC_TXN_CHECKPOINT_OBSOLETE_APPLIED	2263
/*! transaction: update conflicts */
#define	WT_STAT_DSRC_TXN_UPDATE_CONFLICT		2264
