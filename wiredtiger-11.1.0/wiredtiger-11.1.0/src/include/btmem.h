...
//·ÖÆ¬¿Õ¼äºÍ¸³Öµ¿ÉÒÔ²Î¿¼__wt_rec_cell_build_ovfl  __rec_split_write_header
//page->dskÎª¸ÃÀàĞÍ
...
struct __wt_update {
    ...
    //ÊÂÎñÌá½»µÄÊ±ºò»áÔÚ__wt_txn_commit->__wt_txn_releaseÖĞÖÃsession¶ÔÓ¦ÊÂÎñidWT_SESSION_IMPL->txn->idÎªWT_TXN_NONE 
