...
//__evict_reconcileÖÐÈç¹ûÊÇleaf pageÉèÖÃ¸Ã±êÊ¶
...
struct __wt_multi {
    ...
    //´ÓÉÏÃæµÄ±¸×¢¿ÉÒÔ¿´³ö£¬reconcileÒ»¸ömulti¶ÔÓ¦Êý¾ÝÐ´Èë´ÅÅÌºó£¬»áÔÚ¿½±´Ò»·Ýµ½disk_imageÖÐ
 ...
 */
//±éÀú»ñÈ¡internal pageËù°üº¬µÄËùÓÐ×Óref page
...
#define WT_REF_SPLIT 4      /* Parent page split (WT_REF dead) */
     ...
     */
    //Êý¾Ý¶ÔÓ¦µÄ´ÅÅÌµØÖ·???????
    //ÀýÈçevict reconcileÁ÷³ÌÖÐµÄ__wt_multi_to_ref£¬Ö¸Ïò¸Ãpage¶ÔÓ¦µÄ´ÅÅÌÔªÊý¾ÝÐÅÏ¢
    void *addr;
 ...
 */ //__wt_row_ikey_alloc²Î¿¼£¬ref´æµÄÕæÊµpageÉÏ×î´óÊý¾Ýkey
struct __wt_ikey {
