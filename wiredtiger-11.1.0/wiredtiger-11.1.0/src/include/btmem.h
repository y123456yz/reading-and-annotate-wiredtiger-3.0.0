 ...
 * block-manager specific structure.
 ...
 ≤ŒøºreconcileπŸ∑ΩŒƒµµ:https://github.com/wiredtiger/wiredtiger/wiki/Reconciliation-overview
 */
...
struct __wt_page_header {
    ...
    uint64_t recno; /* 00-07: column-store starting recno */ //––¥Ê¥¢∏√ƒ⁄»›Œ™WT_RECNO_OOB
     ...
     */
    //header + data◊‹≥§∂»£¨¥˙±Ì∏√page‘⁄¥≈≈Ã…œ√Êµƒ≥§∂»
    uint32_t mem_size; /* 16-19: in-memory page size */

    union {
        //__wt_rec_split_finishµ±«∞reconcile¥¶¿Ìµƒpage…œ√ÊµƒK∫ÕV◊‹ ˝
        uint32_t entries; /* 20-23: number of cells on page */
        uint32_t datalen; /* 20-23: overflow data length */
    } u;

    //“≤æÕ «∂‘”¶page¿‡–Õ£¨¿˝»ÁWT_PAGE_ROW_LEAF WT_PAGE_BLOCK_MANAGER(±Ì æcheckpointµƒext)
 ...
 */ //“≤æÕ «…œ√Êµƒ__wt_page_headerÕ∑≤øΩ·ππ≥§∂»
...
//dskø™ ºÃ¯π˝page header + block header,“≤æÕ «’‚∏ˆpage∂‘”¶µƒ µº  ˝æ›∆ ºµÿ÷∑
 ...
 */ 
//±£¥Êchunk->image–¥»Î¥≈≈Ã ±∫Úµƒ‘™ ˝æ›–≈œ¢(objectid offset size  checksum)
//∏≥÷µº˚__rec_split_write
//__wt_multi.addrŒ™∏√¿‡–Õ
struct __wt_addr {
...
#define WT_ADDR_LEAF 2    /* Leaf page */ //“Á≥ˆµƒKEY£¨“≤æÕ «¥Ûkey,
#define WT_ADDR_LEAF_NO 3 /* Leaf page, no overflow */
    //__wt_multi_to_ref
    uint8_t type; //∫ÕWT_RECONCILE.ovfl_items∂‘”¶
 ...
 */ //“ª∏ˆpage≤∑÷Œ™∂‡∏ˆpage ±∫Ú”√µΩ£¨ø…“‘≤Œøº__rec_split_dump_keysµƒ±È¿˙,__rec_split_write’‚¿Ô¥¥Ω®ø’º‰∫Õ∏≥÷µ
//π‹¿Ì¥≈≈Ãpage imageµƒƒ⁄¥Ê‘™ ˝æ›–≈œ¢£¨“ª∏ˆ__wt_multi∂‘”¶“ª∏ˆpag ¥≈≈Ãimage
struct __wt_multi {
    /*
     * Block's key: either a column-store record number or a row-store variable length byte string.
     */
    //page≤∑÷∫Û∂‘”¶µƒref key£¨≤Œøº__rec_split_dump_keysµƒ¥Ú”°£¨∏≥÷µµƒµÿ∑Ω‘⁄__rec_split_write
    union {
        uint64_t recno;
        WT_IKEY *ikey;
    } key;
     ...
     * memory.
     */
    //Õ®π˝reconcile∞—“ª∏ˆchunk ˝æ›–¥»Î¥≈≈Ã∫Û£¨ª·øΩ±¥“ª∑›µΩdisk_image, ≤Œøº__rec_split_write
    //“≤æÕ «disk_imageƒ⁄¥Ê“ª∏ˆÕÍ’˚µƒchunk(WT_PAGE_HEADER_SIZE + WT_BLOCK_HEADER_SIZE +  µº  ˝æ›)
    //◊Ó÷’‘⁄__wt_page_inmem÷–∏≥÷µ∏¯page->dsk, »ª∫Û‘⁄__wt_multi_to_ref->__split_multi_inmem->__wt_page_inmem->__inmem_row_leafΩ‚Œˆ
    //¥≈≈Ãpage->dsk÷–µƒK∫ÕVµÿ÷∑–≈œ¢¥Ê»ÎµΩpage->pg_row, ◊Ó∫Û‘⁄__wt_multi_to_ref÷– Õ∑≈disk_image

    //¥”…œ√Êµƒ±∏◊¢ø…“‘ø¥≥ˆ£¨reconcile“ª∏ˆmulti∂‘”¶ ˝æ›–¥»Î¥≈≈Ã∫Û£¨ª·‘⁄øΩ±¥“ª∑›µΩdisk_image÷–£¨◊Ó÷’‘⁄__wt_page_inmem÷–∏≥÷µ∏¯page->dsk
    //»ª∫Û‘⁄__inmem_row_leafΩ‚Œˆ≥ˆ¥≈≈Ã…œµƒK∫ÕVµÿ÷∑±£¥ÊµΩpage->pg_row[]÷–, ◊Ó∫Û Õ∑≈disk_imageø’º‰£¨“≤æÕ «disk_image÷ª «“ª∏ˆ¡Ÿ ±
    //±‰¡ø±£¥Ê–¥»Î¥≈≈ÃµƒÀ˘”–∑‚∞¸ ˝æ›£¨◊Ó÷’ƒøµƒ «Œ™¡ÀªÒ»°page¥≈≈Ã…œKªÚ’ﬂV ˝æ›±£¥ÊµΩpage->pg_row[] ˝◊È÷–
    void *disk_image;
...
#define mod_disk_image u1.r.disk_image
        ...
        //π‹¿Ì¥≈≈Ãpage imageµƒƒ⁄¥Ê‘™ ˝æ›–≈œ¢£¨“ª∏ˆ__wt_multi∂‘”¶“ª∏ˆpag ¥≈≈Ãimage
        struct {//◊¢“‚__wt_reconcile.multi∫Õ__wt_page_modify.mod_multi_entries.multiµƒ«¯±¡™œµ
            //__rec_write_wrapup÷–∏≥÷µ
            WT_MULTI *multi;        /* Multiple replacement blocks */
            //__rec_write_wrapup÷–∏≥÷µ
            uint32_t multi_entries; /* Multiple blocks element count */
        } m;
#undef mod_multi
//∏≥÷µ≤Œøº__rec_write_wrapup£¨ “ª¥ŒreconcileΩ· ¯∫Û£¨reconcileµƒmulti–≈œ¢◊™¥ÊµΩmod->mod_multi÷–
#define mod_multi u1.m.multi
#undef mod_multi_entries
//∏≥÷µ≤Œøº__rec_write_wrapup£¨“ª¥ŒreconcileΩ· ¯∫Û£¨reconcileµƒmulti–≈œ¢◊™¥ÊµΩmod->mod_multi÷–, “≤æÕ «r->multi_next ˝
...
#define mod_col_split_recno u2.column_leaf.split_recno
        struct {
            ...
            //WT_PAGE_ALLOC_AND_SWAP __wt_leaf_page_can_split∑÷≈‰ø’º‰
            WT_INSERT_HEAD **insert;

            /* Updated items for row-stores. */
            //pg_row÷∏œÚ¥≈≈ÃKVœ‡πÿ ˝æ›( µº …œ’‚¿Ô÷∏œÚµƒ «ƒ⁄¥Ê£¨¥”¥≈≈Ãº”‘ÿµƒªÚ’ﬂ¥”ƒ⁄¥Ê–¥»Î¥≈≈Ãµƒ£¨ƒ⁄¥Ê∫Õ¥≈≈Ã∂º”–“ª∑›)£¨mod_row_insert÷∏œÚƒ⁄¥Êœ‡πÿKV ˝æ›£¨mod_row_updateº«¬ºƒ⁄¥Ê÷–Õ¨“ª∏ˆKµƒ±‰∏¸π˝≥Ã
            WT_UPDATE **update;
        } row_leaf;
#undef mod_row_insert
////pg_row÷∏œÚ¥≈≈ÃKVœ‡πÿ ˝æ›( µº …œ’‚¿Ô÷∏œÚµƒ «ƒ⁄¥Ê£¨¥”¥≈≈Ãº”‘ÿµƒªÚ’ﬂ¥”ƒ⁄¥Ê–¥»Î¥≈≈Ãµƒ£¨ƒ⁄¥Ê∫Õ¥≈≈Ã∂º”–“ª∑›)£¨mod_row_insert÷∏œÚƒ⁄¥Êœ‡πÿKV ˝æ›£¨mod_row_updateº«¬ºƒ⁄¥Ê÷–Õ¨“ª∏ˆKµƒ±‰∏¸π˝≥Ã

//__wt_row_modify->WT_PAGE_ALLOC_AND_SWAP°¢__split_insert∑÷≈‰ø’º‰
//WT_ROW_INSERT_SLOTªÒ»°∂‘”¶µƒÃ¯‘æ±Ì£¨ µº …œinsert «∏ˆ ˝◊È£¨ ˝◊È√ø∏ˆ≥…‘±∂‘”¶“ª∏ˆÃ¯‘æ±Ì£¨≤Œøº__wt_leaf_page_can_split
...
#define WT_PAGE_DIRTY 2
    //±Í ∂∏√page◊¥Ã¨£¨ «∑Ò «‘‡page£¨≤Œøº__wt_page_only_modify_set
    uint32_t page_state;

#define WT_PM_REC_EMPTY 1      /* Reconciliation: no replacement */
#define WT_PM_REC_MULTIBLOCK 2 /* Reconciliation: multiple blocks */
#define WT_PM_REC_REPLACE 3    /* Reconciliation: single block */
    //∏¥÷∆≤Œøº__rec_write_wrapup
...
//__wt_page_alloc∑÷≈‰ø’º‰£¨Õ®π˝WT_INTL_INDEX_GET(session, page, pindex);ªÒ»°page∂‘”¶µƒ__wt_page_index
//ø…“‘≤Œøº__split_parent
...
//º«¬º∏√internal page∑÷¡—µƒ¥Œ ˝  __split_parent÷–∏≥÷µ
...
struct __wt_page {
    ...
    union {
         ...
         */
        //≈‰∫œÕº–ŒªØ‘ƒ∂¡https://github.com/wiredtiger/wiredtiger/wiki/In-Memory-Tree-Layout
        struct {
            //÷∏œÚ∏∏Ω⁄µ„µƒpage
 ...
 * destroyed.
 */
//≤ŒøºBTREE ˝Õº–ŒªØ https://github.com/wiredtiger/wiredtiger/wiki/In-Memory-Tree-Layout
...
//pageµƒ__index ˝◊È∏≥÷µ£¨º˚__wt_page_alloc
...
#define WT_INTL_FOREACH_END \
    ...
    while (0)
        ...
        //÷∏œÚ∏√page¥Ê¥¢µƒ’Ê µ ˝æ›£¨º˚__wt_page_alloc
...
//¥≈≈Ã…œµƒ ˝æ›◊Ó÷’”–“ª∑›ÕÍ»´“ª—˘µƒƒ⁄¥Ê ˝æ›¥Ê‘⁄page->dskµÿ÷∑ø™ ºµƒƒ⁄¥Êø’º‰£¨page->pg_row[] ˝◊È√ø∏ˆKªÚ’ﬂV≥…‘± µº …œ÷∏œÚ¿Îpage->dsk∆ ºŒª÷√µƒæ‡¿Î£¨≤Œøº__wt_cell_unpack_safe
//page->dsk¥Ê¥¢ext¥≈≈ÃÕ∑≤øµÿ÷∑£¨page->pg_row[]¥Ê¥¢ µº µƒKªÚ’ﬂVœ‡∂‘Õ∑≤øµƒæ‡¿Î£¨Õ®π˝page->dsk∫Õ’‚∏ˆæ‡¿ÎæÕø…“‘»∑∂®‘⁄¥≈≈Ãext÷–µƒŒª÷√,≤Œøº__wt_page_inmem
#define pg_row u.row
...
#define pg_var_nrepeats u.col_var.repeats->nrepeats
    ...
    //∏≥÷µº˚__wt_page_inmem->__wt_page_inmem
    //¥˙±Ì‘⁄¥≈≈Ãpg_row…œ√ÊµƒKV◊‹ ˝,ø…“‘≤Œøº__wt_evict->__evict_page_dirty_update->__wt_split_multi->__split_multi_lock
...
//__wt_block_extlist_write£¨±Ì æcheckpointµƒext
...
#define WT_PAGE_UPDATE_IGNORE 0x100u      /* Ignore updates on page discard */
    ...
    //__wt_cache_page_inmem_decr÷–◊ˆºı∑®£¨__wt_cache_page_inmem_incr÷–◊ˆº”∑®
    //∏√page∂‘”¶µƒƒ⁄¥Ê£¨∞¸¿®–¥»Î¥≈≈Ãµƒ£¨ø…“‘≤Œøº__evict_force_check
    size_t memory_footprint; /* Memory attached to the page */

    /* Page's on-disk representation: NULL for pages created in memory. */
    //__split_multi_inmem->__wt_page_inmemø…“‘ø¥≥ˆ£¨ µº …œƒ⁄¥Ê“≤”–“ª∑›¥≈≈ÃÕÍ»´“ª—˘µƒƒ⁄¥Ê ˝æ›£¨“≤æÕ «disk_image£¨◊Ó÷’ƒ⁄¥Ê÷–µƒ ˝æ›º«¬ºµΩdsk
    //∏√page”– ˝æ›¥Ê¥¢‘⁄¥≈≈Ã…œ£¨¥≈≈ÃµƒΩ·ππ–≈œ¢Œª÷√, ÷∏œÚ“ª∏ˆ¥≈≈Ãchunk(WT_PAGE_HEADER_SIZE + WT_BLOCK_HEADER_SIZE +  µº  ˝æ›)µƒÕ∑≤øWT_PAGE_HEADER_SIZE

    //‘⁄__split_multi_inmem->__wt_page_inmem÷–∏≥÷µ∏¯¡Àpage->dsk, ≤¢‘⁄÷√Œ™disk_image=NULL£¨ À˘“‘÷∏œÚµƒƒ⁄¥Êø’º‰ µº …œ±ªpage->dskºÃ≥–¡À
    //“≤æÕ «∏√page‘⁄¥≈≈Ã…œµƒ ˝æ›Õ¨—˘ª·¥Ê“ª∑›µΩƒ⁄¥Ê÷–£¨“≤æÕ «¡Ω∑› ˝æ›

    //ÀÊ◊≈splite≤∑÷ÕÍ≥…£¨¿˝»Á¥”¿œpage≤∑÷Œ™10∏ˆ–¬page£¨¿œpage◊Ó÷’ª·Õ®π˝__wt_page_out Õ∑≈
    //page->dsk¥Ê¥¢ext¥≈≈ÃÕ∑≤øµÿ÷∑£¨page->pg_row[]¥Ê¥¢ µº µƒKªÚ’ﬂVœ‡∂‘Õ∑≤øµƒæ‡¿Î£¨Õ®π˝page->dsk∫Õ’‚∏ˆæ‡¿ÎæÕø…“‘»∑∂®‘⁄¥≈≈Ãext÷–µƒŒª÷√,≤Œøº__wt_page_inmem
    //__wt_page_out->__wt_overwrite_and_free_len÷– Õ∑≈

    //__wt_cache_bytes_image÷–º«¬º◊‹µƒimageƒ⁄¥Êœ˚∫ƒ£¨“≤æÕ «–¥»Îext ±∫Ú‘⁄ƒ⁄¥Ê÷– µº …œ”–Õ¨—˘“ª∑›µƒƒ⁄¥Êº∆À„Õ≥º∆

     //≈‰∫œ__wt_rec_cell_build_addr‘ƒ∂¡£¨[page->dsk, page->dsk + page->dsk->mem_size]∂‘”¶¥≈≈Ã“ª∏ˆextøÈ
    //’‚∏ˆext÷–¥Ê¥¢µƒ «“ª∏ˆ“ª∏ˆµƒWT_ADDR£¨“ª∏ˆWT_ADDR∂‘”¶“ª∏ˆ◊”pageµƒ¥≈≈Ã‘™ ˝æ›
    const WT_PAGE_HEADER *dsk; //∏≥÷µº˚__wt_page_inmem£¨÷∏œÚ¥≈≈Ã ˝æ›
 ...
 *	A single in-memory page and state information.
 ...
 BTREEÕº–ŒªØ≤Œøºhttps://github.com/wiredtiger/wiredtiger/wiki/In-Memory-Tree-Layout
 */ //btree∂‘”¶root page,∏≥÷µ≤Œøº__btree_tree_open_empty
struct __wt_ref {
    WT_PAGE *page; /* Page */
...
//±Í ∂∏√page ˝æ›‘⁄disk÷–,evict∞—ƒ⁄¥Êpage–¥»Î¥≈≈Ã∫Û‘⁄__wt_multi_to_ref÷–÷√Œ™∏√◊¥Ã¨
#define WT_REF_DISK 0       /* Page is on disk */
//__btree_tree_open_empty¥¥Ω®root pageµƒ ±∫Ú≥ı ºªØŒ™∏√÷µ
#define WT_REF_DELETED 1    /* Page is on disk, but deleted */
#define WT_REF_LOCKED 2     /* Page locked for exclusive access */
//–¬¥¥Ω®µƒleaf pageæÕª·…Ë÷√Œ™∏√◊¥Ã¨  __wt_btree_new_leaf_page¥¥Ω®leaf page∫Û£¨∏√leaf page∂‘”¶◊¥Ã¨Œ™WT_REF_MEM
//µ±reconcile evict≤∑÷pageŒ™∂‡∏ˆ£¨≤¢«“–¥»Î¥≈≈Ãext£¨’‚ ±∫Úpage◊¥Ã¨Ω¯»ÎWT_REF_DISK, µ±unpackΩ‚∞¸ªÒ»°µΩ∏√extµƒÀ˘”–KªÚ’ﬂV‘⁄œ‡±»extÕ∑≤ø
//∆´“∆¡ø∫Û£¨÷ÿ–¬÷√Œ™WT_REF_MEM◊¥Ã¨£¨±Ì æŒ“√«“—æ≠ªÒ»°µΩext÷–∞¸∫¨µƒÀ˘”–K∫ÕV¥≈≈Ã‘™ ˝æ›µÿ÷∑¥Ê¥¢µΩ¡Àƒ⁄¥Êpg_row÷–£¨≤Œøº__wt_multi_to_ref
#define WT_REF_MEM 3        /* Page is in cache and valid */
#define WT_REF_SPLIT 4      /* Parent page split (WT_REF dead) */
    //WT_REF_SET_STATE WT_REF_CAS_STATE∏≥÷µ
     ...
     */
    //Õ®π˝ref->addrø…“‘≈–∂œ≥˝∏√ref∂‘”¶page «∑Ò¬ﬁ≈Ã¡À __wt_ref_block_free
    //¿˝»Áevict reconcile¡˜≥Ã÷–µƒ__wt_multi_to_ref£¨÷∏œÚ∏√page∂‘”¶µƒ¥≈≈Ãext‘™ ˝æ›–≈œ¢WT_ADDR(objectid offset size  checksum)
    //»Áπ˚ «root page£¨∆‰addr=NULL, »Áπ˚page‘⁄ƒ⁄¥Ê÷–£¨¿˝»Áinternal page(≤ª∞¸¿®root page)ªÚ’ﬂleaf page‘⁄ƒ⁄¥Ê÷–£¨ªπ√ª”–≥÷æ√ªØ

    //÷ÿ∆Ù ±∫Ú¥”__inmem_row_int÷–¥”root‘™ ˝æ›ext÷–º”‘ÿ√ø∏ˆpageµƒ¥≈≈Ãaddr–≈œ¢
//ø…“‘≤Œøº‘⁄__wt_sync_file÷–ª·±È¿˙À˘”–µƒbtreeπ˝≥Ã£¨ø¥__wt_sync_file «»Á∫Œ±È¿˙btreeµƒ£¨»ª∫Û◊ﬂµΩ’‚¿Ô
/*
                        root page
                        /         \
                      /             \
...
…œ√Ê’‚“ªø√ ˜µƒ±È¿˙À≥–Ú: leaf1->leaf2->internal1->leaf3->leaf4->internal2->root
*/ 
//¥”…œ√ÊµƒÕºø…“‘ø¥≥ˆ£¨internal page(root+internal1+internal2)◊‹π≤»˝¥Œ◊ﬂµΩ’‚¿Ô, internal1º«¬ºleaf1∫Õleaf2µƒpage addr‘™ ˝æ›[ref key, leaf page ext‘™ ˝æ›]
//  internal2º«¬ºleaf3∫Õleaf4µƒpage addr‘™ ˝æ›[ref key, leaf page ext‘™ ˝æ›], 
//  rootº«¬ºinternal1∫Õinternal2µƒ addr‘™ ˝æ›[ref key, leaf page ext‘™ ˝æ›], 
    void *addr;//∂‘”¶WT_ADDR£¨≤Œøº__wt_multi_to_ref
...
#undef ref_ikey
////WT_REF.ref_ikey ref∂‘”¶µƒkey£¨__wt_row_ikey  __wt_ref_key_onpage_set÷–∏≥÷µ
//º«¬ºµƒ «∂‘”¶pageµƒ◊Ó–°key
 ...
 */
//¥˙±Ì¥≈≈Ã…œ√Êµƒ“ªÃıKV ˝æ›£¨≤Œøº__debug_page_row_leaf
 ...
 */
//pg_row÷∏œÚ¥≈≈ÃKVœ‡πÿ ˝æ›£¨mod_row_insert÷∏œÚƒ⁄¥Êœ‡πÿKV ˝æ›£¨mod_row_updateº«¬ºƒ⁄¥Ê÷–Õ¨“ª∏ˆKµƒ±‰∏¸π˝≥Ã
 ...
 */
//“≤æÕ «±Í ∂rip∂‘”¶KV‘⁄pageƒ⁄¥Êpg_row÷–µƒ”Œ±Í
 ...
 */ //__wt_row_ikey_alloc≤Œøº£¨ref¥Êµƒ’Ê µpage…œ◊Ó–° ˝æ›key
struct __wt_ikey {
    //key≥§∂»
     ...
     */
    //º«¬ºK‘⁄ƒ⁄¥Ê÷–µƒŒª÷√£¨≤Œøº__wt_row_ikey_alloc
    //≤ªŒ™0‘Ú∂‘”¶¥≈≈Ãpage ˝æ›º”‘ÿµΩƒ⁄¥Ê÷–page->dskµƒŒª÷√
    //±Ì æ∏√ref key∂‘”¶µƒrefœ¬√Êµƒpage“—æ≠–¥»ÎµΩ¥≈≈ÃªÚ’ﬂ¥”¥≈≈Ãº”‘ÿµƒ
    uint32_t cell_offset;
 ...
 */ //∑÷≈‰__wt_upd_allocø’º‰
//∑÷≈‰__wt_upd_allocø’º‰ //KV÷–µƒkey∂‘”¶WT_INSERT£¨value∂‘”¶WT_UPDATE(WT_INSERT.upd)
//__wt_insert.updŒ™∏√¿‡–Õ,º«¬ºµƒ «Vµƒ±‰ªØπ˝≥Ã
struct __wt_update {
    /*
     * Transaction IDs are set when updates are created (before they become visible) and only change
     * when marked with WT_TXN_ABORTED. Transaction ID readers expect to copy a transaction ID into
 ...
 */ //__wt_cursor_btree.modify_updateŒ™∏√¿‡–Õ
 ...
 * to re-implement, IMNSHO.)
  Ã¯‘æ±ÌÕºΩ‚≤Œøºhttps://www.jb51.net/article/199510.htm

 */ 
//__wt_row_insert_alloc  WT_INSERTÕ∑≤ø+levelø’º‰+’Ê µ ˝æ›key
//mod_row_insertŒ™∏√¿‡–Õ£¨“ª∏ˆinsertKV∂‘”¶µƒ__wt_insert∂º‘⁄mod_row_insert∂‘”¶Ã¯‘æ±Ì÷–
struct __wt_insert {
    WT_UPDATE *upd; /* value */ //value‘⁄’‚¿Ô  __wt_insert.updŒ™∏√¿‡–Õ
...
#define WT_INSERT_RECNO(ins) (((WT_INSERT *)(ins))->u.recno)
    ...
    // ˝◊È¥Û–°∫ÕÀÊª˙≤„ ˝œ‡πÿ£¨≤Œøº__wt_row_insert_alloc
 ...
 * 	The head of a skiplist of WT_INSERT items.
     ≈‰∫œWT_SKIP_FOREACH   WT_SKIP_LAST     WT_SKIP_FIRST‘ƒ∂¡
 Ã¯‘æ±ÌÕºΩ‚≤Œøºhttps://www.jb51.net/article/199510.htm
 */ //WT_PAGE_ALLOC_AND_SWAP÷–ª·∑÷≈‰ø’º‰
