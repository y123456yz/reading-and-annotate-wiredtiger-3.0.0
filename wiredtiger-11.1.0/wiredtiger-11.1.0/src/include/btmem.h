...
#define WT_PAGE_UPDATE_IGNORE 0x100u      /* Ignore updates on page discard */
    ...
    //__wt_cache_bytes_imageÖĞ¼ÇÂ¼×ÜµÄimageÄÚ´æÏûºÄ£¬Ò²¾ÍÊÇĞ´ÈëextÊ±ºòÔÚÄÚ´æÖĞÊµ¼ÊÉÏÓĞÍ¬ÑùÒ»·İµÄÄÚ´æ¼ÆËãÍ³¼Æ
     ...
     //ÅäºÏ__wt_rec_cell_build_addrÔÄ¶Á£¬[page->dsk, page->dsk + page->dsk->mem_size]¶ÔÓ¦´ÅÅÌÒ»¸öext¿é
    //Õâ¸öextÖĞ´æ´¢µÄÊÇÒ»¸öÒ»¸öµÄWT_ADDR£¬Ò»¸öWT_ADDR¶ÔÓ¦Ò»¸ö×ÓpageµÄ´ÅÅÌÔªÊı¾İ
...
//  root¼ÇÂ¼internal1ºÍinternal2µÄ addrÔªÊı¾İ[ref key, leaf page extÔªÊı¾İ],
    void *addr;//¶ÔÓ¦WT_ADDR£¬²Î¿¼__wt_multi_to_ref
