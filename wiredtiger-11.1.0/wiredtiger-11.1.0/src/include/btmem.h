...
struct __wt_update {
    ...
    //__wt_txn_commit->__wt_txn_op_set_timestamp¼ÇÂ¼¸Ã²Ù×÷ÔÚÊÂÎñÖĞÌá½»µÄÊ±¼äµãdurable_timestamp¼ÇÂ¼µ½durable_tsÖĞ
    wt_timestamp_t durable_ts; /* timestamps */
    //__wt_txn_commit->__wt_txn_op_set_timestamp¼ÇÂ¼¸Ã²Ù×÷ÔÚÊÂÎñÖĞÌá½»µÄÊ±¼äµãcommit_timestamp¼ÇÂ¼µ½start_tsÖĞ
