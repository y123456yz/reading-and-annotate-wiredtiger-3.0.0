...
//参考https://source.wiredtiger.com/11.1.0/struct_w_t___s_e_s_s_i_o_n.html
...
//例如WT_CONFIG_ENTRY_wiredtiger_open  例如cfg[0] = WT_CONFIG_BASE(session, wiredtiger_open);
static const WT_CONFIG_ENTRY config_entries[] = {{"WT_CONNECTION.add_collator", "", NULL, 0},
  ...
  //WT_CONFIG_ENTRY_wiredtiger_open  例如cfg[0] = WT_CONFIG_BASE(session, wiredtiger_open);
  {"wiredtiger_open",
