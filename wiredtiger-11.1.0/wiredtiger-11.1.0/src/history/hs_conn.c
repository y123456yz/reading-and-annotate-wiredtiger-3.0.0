...
__hs_cleanup_las(WT_SESSION_IMPL *session)
{
    ...
    /*
    The WiredTigerLAS.wt file was removed in MongoDB 4.4, so I would encourage you to upgrade to the latest MongoDB version (5.0.4, currently 2).
    ...
    https://www.mongodb.com/community/forums/t/wiredtigerlas-wt-keeps-on-growing-causing-mongodb-to-crash-what-are-the-risks-of-removing-it-and-what-are-its-contents/132607
