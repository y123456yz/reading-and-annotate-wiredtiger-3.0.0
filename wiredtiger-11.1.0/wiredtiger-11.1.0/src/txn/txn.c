...
//Ïò¸±±¾¼¯ÊµÀý²»Í£µÄÐ´Êý¾Ý£¬»á²»Í£´òÓ¡¸üÐÂstable timestampºÍoldest timestamp£¬Á½¸ö²îÖµ¾ÍÊÇÄ¬ÈÏµÄminSnapshotHistoryWindowInSeconds=300Ãë
    ...
    //pinned_timestampÊÇÔÚ__wt_txn_update_pinned_timestampÖÐ¸ù¾Ýoldest_timestamp¡¢checkpoint_timestampºÍËùÓÐÊÂÎñµÄread_timestampÈ¡×îÐ¡ÖµËã³öÀ´µÄ£¬(mongodb txnOpen.setReadSnapshot(_readAtTimestamp);)
    //Êµ¼ÊÉÏÕæÊµÓÃ´¦ÈçÏÂ:
