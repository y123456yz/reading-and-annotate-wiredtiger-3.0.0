...
class test_verbose04(test_verbose_base):
    ...
    def test_verbose_single(self):
        ...
        # 'all' category.
        with self.expect_verbose(['all:1'], ['WT_VERB_ALL'], self.is_json) as conn:
            # Perform a set of simple ALL operations to generate verbose  messages.
        ...
        with self.expect_verbose(['all:0'], ['WT_VERB_ALL'], self.is_json, False) as conn:
