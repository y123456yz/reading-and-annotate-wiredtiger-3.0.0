...
//这个文件替换test/csuit/timestamp_abort.c重新编译，运行rm -rf WT_TEST.test_timestamp_abort* && clear && ./test_timestamp_abort -T 20 -t 60
/* 
coredump信息如下:
yang test ............................__wt_evict_file.......... 
yang test .................__wt_rec_split_finish................ 
yang test ..........__rec_split_finish_process_prev......combined_size:50991,r->page_size:32768, prev_ptr->min_offset:16247, cur_ptr->image.size:22450
yang test ....111111111111111111111......__rec_split_finish_process_prev
yang test .................__rec_split_discard..............................
yang test ..............................page is root, page:0x2ae0240, ref:0x2acf190, type:row-store internal
yang test .................__wt_rec_split_finish................ 
[1712459158:84220][43001:0x7fbf810de700], file:oplog.wt, WT_SESSION.__session_checkpoint: [WT_VERB_DEFAULT][ERROR]: __wt_block_extlist_truncate, 1596: ext->off + ext->size <= block->size
[1712459158:84236][43001:0x7fbf810de700], file:oplog.wt, WT_SESSION.__session_checkpoint: [WT_VERB_DEFAULT][ERROR]: __wt_abort, 28: aborting WiredTiger library
test_timestamp_abort: FAILED: Child process 43001 abnormally exited: Invalid argument
...
#define ENV_CONFIG_DEF                                        \
    "cache_size=%" PRIu32                                     \
    "M,create,verbose=[config_all_verbos:0,api:2, transaction:5,history_store=5,history_store_activity=5],"                  \
   ...
   // for (i = td->start;; ++i) {
    ...
    for (i = td->start;i < td->start + 10; ++i) {
...

        {
            ...
            ret = __wt_verbose_dump_txn(conn_tmp->default_session, "timestamp thread_run 1");//yang add change
            WT_UNUSED(ret);
        }
        ...
        
        {
            ...
            //WT_CONNECTION *conn_tmp2;
            conn_tmp = S2C(session);
            ret = __wt_verbose_dump_txn(conn_tmp->default_session, "timestamp thread_run 2");//yang add change
            WT_UNUSED(ret);
        }
