...
#define CONN_CONFIG "create,cache_size=100MB,log=(enabled=true,file_max=100K,remove=false),verbose=[config_all_verbos:5]"
#define MAX_ITERATIONS 5
#define MAX_KEYS 100 //10000
...
take_full_backup(WT_SESSION *session, int i)
{
    ...
    //__wt_curbackup_open
    error_check(session->open_cursor(session, "backup:", NULL, "target=(\"table:logtest\")", &cursor));
